...
const reasonCards = [
    ...
    },
    {
        num: "02",
        title: "AI 리더 네트워크",
        desc: "서울 지역 리더들과 함께 실행 중심 네트워크를 구축합니다.",
    },
    {
        num: "03",
        title: "수료증 제공",
...
> = {
    "01": {
        schedule: "2026년 7월 16일",
        description: "",
    },
    "02": {
        schedule: "2026년 7월 23일",
        description: "",
    },
    "03": {
        schedule: "2026년 7월 30일",
        description: "",
    },
    "04": {
        schedule: "2026년 8월 6일",
        description: "",
    },
    "05": {
        schedule: "2026년 8월 13일",
        description: "",
    },
    "06": {
        schedule: "2026년 8월 20일",
        description: "",
    },
    "07": {
        schedule: "2026년 8월 27일",
        description: "",
    },
    "08": {
        schedule: "2026년 9월 3일",
        description: "",
    },
    "09": {
        schedule: "2026년 9월 10일",
        description: "",
    },
    "10": {
        schedule: "2026년 9월 17일",
        description: "",
    },
};
                            ...
                            <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3">
                                {instructorImages.map((instructor) => (
                                    <article key={instructor.id} className="group relative flex h-full flex-col items-center bg-transparent text-center">
                                        ...
                                        <p className="mt-5 text-sm leading-6 text-[rgba(15,24,45,0.78)]">
